		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo CICD",
									"targetURL": "#sapcomdemocicd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomdemocicd-display": {
								"semanticObject": "sapcomdemocicd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.democicd",
									"url": sap.ui.require.toUrl("sap/com/democicd")
								}
							}
						}
					}
